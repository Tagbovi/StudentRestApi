...
namespace StudentRestAPI.Models
{
    public class StudentRepository : IStudentRepository
    {
        ...
        public StudentRepository(AppDbContext appDbContext) { this.appDbContext = appDbContext; }
        ...
        {
            var results = await appDbContext.Students.FirstOrDefaultAsync(e => e.StudentId == studentId);
            if (results != null)
            {
                appDbContext.Students.Remove(results);
                await appDbContext.SaveChangesAsync();
            }
        }
        ...
        public async Task<Student?> UpdateStudent(Student student)
        {
            ...
            //It checks if the StudentId property of each student entity (e) in the database
            //matches the StudentId of the student object you want to find.
